...
_G.packer_plugins = {
  ...
  ["codeium.vim"] = {
    ...
    loaded = true,
    path = "/Users/marcarlotuico/.local/share/nvim/site/pack/packer/start/codeium.vim",
  ...
  ["git-blame.nvim"] = {
    loaded = true,
    path = "/Users/marcarlotuico/.local/share/nvim/site/pack/packer/start/git-blame.nvim",
  ...
  ["lualine.nvim"] = {
    loaded = true,
    path = "/Users/marcarlotuico/.local/share/nvim/site/pack/packer/start/lualine.nvim",
  ...
  ["nvim-surround"] = {
    ...
    loaded = true,
    path = "/Users/marcarlotuico/.local/share/nvim/site/pack/packer/start/nvim-surround",
    url = "https://github.com/kylechui/nvim-surround"
  },
  ["nvim-treesitter"] = {
    after = { "nvim-ts-autotag" },
    config = { "\27LJ\2\n7\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\28martuico.lsp.treesitter\frequire\0" },
    loaded = true,
    only_config = true,
  ...
  ["toggleterm.nvim"] = {
    ...
    loaded = true,
    path = "/Users/marcarlotuico/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
  ...
  ["vscode-es7-javascript-react-snippets"] = {
    loaded = true,
    path = "/Users/marcarlotuico/.local/share/nvim/site/pack/packer/start/vscode-es7-javascript-react-snippets",
...
try_loadstring("\27LJ\2\n7\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\28martuico.lsp.treesitter\frequire\0", "config", "nvim-treesitter")
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-tw2css'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
