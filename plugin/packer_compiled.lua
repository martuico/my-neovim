...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-autotag", "nvim-ts-rainbow2" },
  ...
  ["nvim-ts-rainbow2"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/Users/marcarlotuico/.local/share/nvim/site/pack/packer/opt/nvim-ts-rainbow2",
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-tw2css', 'LuaSnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
